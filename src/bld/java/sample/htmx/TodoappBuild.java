...
public class TodoappBuild extends WebProject {
    public TodoappBuild() {
        ...
        scope(standalone)
            .include(dependency("org.eclipse.jetty.ee10:jetty-ee10-servlet:12.0.6"))
            .include(dependency("org.eclipse.jetty.ee10:jetty-ee10:12.0.6"))
            .include(dependency("org.slf4j:slf4j-simple:2.0.11"));
